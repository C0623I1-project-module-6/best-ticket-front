...
const BookingManagerEventSummarize = () => {
        ...
        const bookings = useSelector(selectAllBookingsByEventIdNoPaged);
        ...
        useEffect(() => {
            dispatch(getAllBookingsByEventIdNoPaged(eventId));
        }, [dispatch, eventId]);
        ...
        }, [bookings, serviceFee, soldTicketsCount, soldTicketsTotalAmount]);
                    ...
                    <div className="mt-16 mb-10 mx-[10%] border border-gray-300 rounded-xl text-black">
                        <div className="flex">
                            ...
                            <div className="w-3/6 my-14">
                                <div className="text-xl pb-2">{event !== null ? event.name :
                                    <div>Loading...</div>}</div>
                                <div>{event !== null ? (
                                        <div className="flex">
